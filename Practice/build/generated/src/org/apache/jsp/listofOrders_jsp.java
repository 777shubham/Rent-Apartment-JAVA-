...
import login.registration.ListingBean;
...
public final class listofOrders_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<ListingBean> ar2 = (ArrayList<ListingBean>)request.getAttribute("LordOne"); 
      ...
      out.write("        <title>Owned Apartments</title>\n");
      ...
      out.write("      <a class=\"navbar-brand\" href=\"front.jsp\">MyHOME</a>\n");
      out.write("    </div>\n");
      out.write("  </div>\n");
      out.write("</nav>\n");
      out.write("        \n");
      out.write("    <center><h3 class=\"rainbow\"> My Order(s).</h3></center>\n");
  ...
  if(!ar2.isEmpty()){
      ...
      { 
      out.write("\n");
      out.write("      <div style=\"height:300px;\" id=\"lol\">\n");
      out.write("       <a href=");
      out.print( ar2.get(i).getImgLink());
      out.write(" target=\"_blank\" >\n");
      out.write("           <img src=");
      out.print( ar2.get(i).getImgLink());
      out.write(" width=\"300\" height=\"300\" style=\"float:left;margin:0 20px 20px 0;\"> </a>\n");
      out.write("      <p style=\"color:#9C27B0;\">Email :");
      out.print( ar2.get(i).getUserEmail());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">State :");
      out.print( ar2.get(i).getState());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Address :");
      out.print( ar2.get(i).getAddress());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Bedrooms :");
      out.print( ar2.get(i).getBedrooms());
      out.write("</p>\n");
      out.write("      <p style=\"color:#9C27B0;\">Requested status :");
      out.print( ar2.get(i).getRequestStatus());
      out.write("</p>\n");
      out.write("      <form method=\"post\" action=\"CancelRequest\" onsubmit=\"func1()\">\n");
      out.write("          <input type=\"hidden\" name=\"APD\" value=");
      out.print(ar2.get(i).getApId());
      out.write(" >\n");
      out.write("                    <button type=\"submit\" class=\"btn btn-danger\">Cancel Request</button>\n");
      out.write("      <input type=\"submit\" value=\"Cancel Request\"></form>\n");
      out.write("\n");
      out.write("    </div>\n");
      out.write("  </div>\n");
      out.write("  </div>\n");
