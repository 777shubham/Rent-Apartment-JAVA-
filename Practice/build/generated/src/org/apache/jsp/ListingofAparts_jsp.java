...
public final class ListingofAparts_jsp extends org.apache.jasper.runtime.HttpJspBase
 ...
 ArrayList<ListingBean> ar = (ArrayList<ListingBean>)request.getAttribute("Lord"); 
      ...
      out.write("            {\n");
      out.write("                \n");
      out.write("                    alert(\"Apartment Requested ,Check My Orders\");\n");
      out.write("            }\n");
      out.write("      </script>\n");
      out.write("  <style>\n");
      out.write("    p {\n");
      ...
      out.write("        <a class=\"navbar-brand\" href=\"front.jsp\"><h5 style=\"font-color:white;\">HOME</h5></a>\n");
      out.write("    </div>\n");
      out.write("  </div>\n");
      out.write("</nav>\n");
      out.write("\n");
  ...
  if(!ar.isEmpty()){
      ...
      out.write("           <img src=");
      out.print( ar.get(i).getImgLink());
      out.write(" width=\"250\" height=\"250\" style=\"float:left;margin:0 20px 20px 0;\"> </a>\n");
      out.write("      <p style=\"color:red;\">Email :");
      out.print( ar.get(i).getUserEmail());
      out.write("</p>\n");
      out.write("      <p style=\"color:red;\">State :");
      out.print( ar.get(i).getState());
      out.write("</p>\n");
      out.write("        <p style=\"color:red;\">Address :");
      out.print( ar.get(i).getAddress());
      out.write("</p>\n");
      out.write("      <p style=\"color:red;\">Bedrooms :");
      out.print( ar.get(i).getBedrooms());
      out.write("</p>\n");
      out.write("      <form method=\"post\" action=\"BuyingRequest\" onsubmit=\"funct()\">\n");
      out.write("      <input type=\"hidden\" name=\"APD\" value=");
      out.print(ar.get(i).getApId());
      out.write(" >\n");
      out.write("      <input type=\"hidden\" name=\"AP20\" value=");
      out.print( ar.get(i).getUserEmail());
      out.write(" >\n");
      out.write("      <button type=\"submit\" class=\"btn btn-success\">Request Apartment</button>\n");
